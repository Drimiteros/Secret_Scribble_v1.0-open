...
> Please keep in mind that the current version (open 1.0) has some security flaws and weak security measures. This version is currently not recommended for real-world use or a serious security measure. And please pardon my junky and unprofessional code 😅
